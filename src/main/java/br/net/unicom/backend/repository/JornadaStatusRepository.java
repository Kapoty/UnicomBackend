...
public interface JornadaStatusRepository extends JpaRepository<JornadaStatus, Long> {
    ...
    @Query(value = "SELECT * FROM jornada_status WHERE jornada_status_id = :jornadaStatusId and (empresa_id = :empresaId OR contrato_id = :contratoId)", nativeQuery = true)
